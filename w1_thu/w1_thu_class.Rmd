...
The function `get_urls` is to get the urls of 50 posts from a page. 
And the function `get_text` is to get all the content and comments from a post.
...
Here's the definition of the function `wait`. It just literally wait for 1 minute.
...
The function `combine_data` is to take the new text, count the frequency of words,
